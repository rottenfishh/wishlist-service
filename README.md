...
- Создание, редактирование, удаление вишлистов и позиций в нем (только для авторизированных пользователей)
...
### Github actions
**workflow**  проекта  можно запустить через **Github Actions**
...
Для запуска юнит тестов локально:
...
- **Интеграционные тесты** сценариев создания вишлиста и бронирования в нем позиции ./tests
...
#### Авторизация
`POST /api/auth/register` - регистрация нового пользователя по email и password.
